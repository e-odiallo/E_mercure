...
function initMap() {
    ...
    navigator.geolocation.getCurrentPosition(function(location) {
        ...
        document.getElementById("myLoc").className = "btn-floating blue pulsing";
...
function addSpot(){
    ...
    xhttp.open("GET", "https://activdoor.000webhostapp.com/php/index.php?action=isConnected", true);
    xhttp.send();
}
